...
export b_radius=$(( b_height*20/100 ))   # block rad 20% of height (type1)
export c_radius=$(( b_height*15/100 ))   # block rad 15% of height {type2}
export t_radius=$(( b_height*15/100 ))   # tooltip rad 15% of height
...
export w_margin=$(( b_height*20/100 ))   # workspace margin 10% of height
